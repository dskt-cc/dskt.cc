...
import { HiOutlineUser, HiOutlineTag, HiOutlineCube, HiOutlineCollection } from 'react-icons/hi';
...
const CustomImage = ({ src, alt, repo }: { src: string; alt: string; repo: string }) => {
