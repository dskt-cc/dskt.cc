...
export const ModCard = ({ mod, onMetaLoaded }: ModCardProps) => {
    ...
    return (
        <div className="group relative overflow-hidden rounded-xl bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 transition-all duration-300 hover:border-gray-600/50 hover:shadow-2xl hover:shadow-purple-500/10">
